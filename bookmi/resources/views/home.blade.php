        ...
        <a href="{{ route('meet-and-greet.show', $exp->id) }}"
           ...
           onmouseout="this.style.transform='';this.style.boxShadow='0 2px 12px rgba(109,40,217,0.06)';this.style.borderColor='rgba(109,40,217,0.12)'">
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:1.25rem;">
                <div style="width:44px; height:44px; border-radius:12px; background:linear-gradient(135deg,#8B5CF6,#6D28D9); display:flex; align-items:center; justify-content:center; font-weight:900; font-size:1.1rem; color:white; flex-shrink:0;">
                    {{ $init }}
                </div>
