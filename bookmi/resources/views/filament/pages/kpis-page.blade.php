<x-filament-panels::page>
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <x-filament::card>
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ number_format($kpis['total_users'], 0, ',', '.') }}</div>
        ...
        <x-filament::card>
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ number_format($kpis['total_bookings'], 0, ',', '.') }}</div>
        ...
        <x-filament::card>
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ number_format($kpis['avg_booking_value'], 0, ',', '.') }}</div>
    ...
    <x-filament::card class="mt-6">
                ...
                <tbody>
                    ...
                    @foreach ($monthlyRevenue as $month)
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="py-2 px-3 text-right font-mono text-gray-900 dark:text-white">{{ number_format($month['revenue'], 0, ',', '.') }}</td>
                            <td class="py-2 px-3">
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between text-sm">
            ...
            <span class="font-bold text-gray-900 dark:text-white">{{ number_format($kpis['total_revenue'], 0, ',', '.') }} FCFA</span>
        </div>
    </x-filament::card>
</x-filament-panels::page>
