...
<div
    class="flex h-screen"
    style="background:linear-gradient(135deg,#dbeafe 0%,#e8e4ff 30%,#ddf4ff 65%,#d1fae5 100%)"
    ...
    >
        ...
        <div class="px-6 py-5 flex items-center justify-between">
            <a href="{{ route('home') }}" class="flex items-center">
                ...
                <span class="font-extrabold text-2xl tracking-tight leading-none" style="color:#2196F3">Mi</span>
            </a>
