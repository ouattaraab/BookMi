...
class BookingRequestResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'client_confirmed_arrival_at' => $this->client_confirmed_arrival_at?->toIso8601String(),
            'dispute_reason'         => $this->dispute_reason?->value,
            'dispute_reason_label'   => $this->dispute_reason?->label(),
            'dispute_comment'        => $this->dispute_comment,
            'disputed_at'            => $this->disputed_at?->toIso8601String(),
            'dispute_admin_response' => $this->dispute_admin_response,
